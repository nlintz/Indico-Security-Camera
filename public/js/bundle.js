...
var UserProbas = React.createClass({
    ...
    render: function render() {
        ...
        var otherUserCards = otherUsers.map(function (user) {
            return React.createElement(
                'div',
                { key: user.name, className: 'col s12 l3' },
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'col s12 l4 offset-l4' },
                    React.createElement(
                        'h3',
                        null,
                        'Who is at the door?'
                    ),
                    React.createElement(UserCard, { user: userAtDoor, large: true })
                )
            ),
            React.createElement(
                'div',
...
var SecurityCam = React.createClass({
    ...
    getInitialState: function getInitialState() {
        return { users: [{ name: "luke", p_at_door: 0.0 }, { name: "nathan", p_at_door: 0.0 }, { name: "diana", p_at_door: 0.0 }, { name: "slater", p_at_door: 0.0 }, { name: "background", p_at_door: 0.0 }],
            last_update: ""
        };
    },
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'nav',
                { className: 'navigation blue darken-2' },
                React.createElement(
                    'div',
            ...
            React.createElement(
                'div',
                { className: 'container' },
                React.createElement(UserProbas, { users: this.state.users }),
...
ReactDOM.render(React.createElement(SecurityCam, null), document.getElementById('content'));
